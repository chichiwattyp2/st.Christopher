(function($) {
  ...
  $(".between").each(function() {
    ...
    var LineScene = new ScrollMagic.Scene({
      ...
      .setTween(animateLine)
      .addTo(controllerLine);
  });
  ...
  $(".fades").each(function() {
    ...
    var FadesScene = new ScrollMagic.Scene({
      ...
      .setTween(animateFades)
      .addTo(controllerFades);
  });
