      ...
      AFRAME.registerComponent("audioanalyser", {
        ...
        update: function(t) {
          var e = this.analyser,
            n = this.data;
          (t.fftSize === n.fftSize &&
            t.smoothingTimeConstant === n.smoothingTimeConstant) ||
            ((e.fftSize = n.fftSize),
            (e.smoothingTimeConstant = n.smoothingTimeConstant),
            (this.levels = new Uint8Array(e.frequencyBinCount)),
            (this.waveform = new Uint8Array(e.fftSize))),
            n.src && this.refreshSource();
        },
        tick: function(t, e) {
          var n,
            i = this.data;
          if (i.enabled) {
            if (
              ((i.enableLevels || i.enableVolume) &&
                this.analyser.getByteFrequencyData(this.levels),
              i.enableWaveform &&
                this.analyser.getByteTimeDomainData(this.waveform),
              i.enableVolume || i.enableBeatDetection)
            ) {
              for (var o = 0, r = 0; r < this.levels.length; r++)
                o += this.levels[r];
              this.volume = o / this.levels.length;
            }
            i.enableBeatDetection &&
              ((n = this.volume),
              this.beatCutOff || (this.beatCutOff = n),
              n > this.beatCutOff && n > this.data.beatDetectionMinVolume
                ? (this.el.emit("audioanalyserbeat", null, !1),
                  (this.beatCutOff = 1.5 * n),
                  (this.beatTime = 0))
        ...
        initContext: function() {
          ...
          (this.context = new (window.webkitAudioContext ||
            window.AudioContext)()),
            (t = this.analyser = this.context.createAnalyser()),
            (e = this.gainNode = this.context.createGain()),
            e.connect(t),
            t.connect(this.context.destination),
            (t.fftSize = n.fftSize),
            (t.smoothingTimeConstant = n.smoothingTimeConstant),
            (this.levels = new Uint8Array(t.frequencyBinCount)),
            (this.waveform = new Uint8Array(t.fftSize));
        },
        refreshSource: function() {
          var t = this,
            e = (this.analyser, this.data);
        ...
        fetchAudioBuffer: function(t) {
          ...
          return i[t]
            ...
            : (this.data.cache ||
              ...
              (i[t] = new Promise(function(n) {
                var o = (e.xhr = new XMLHttpRequest());
                o.open("GET", t),
                  ...
                  o.addEventListener("load", function() {
                    ...
                    var a = e.context.decodeAudioData(o.response, r);
                    a &&
                      a.constructor === Promise &&
                      a.then(r).catch(console.error);
                  }),
                  o.send();
              })),
              i[t]);
        ...
        getBufferSource: function() {
          var t = this,
            e = this.data;
          return this.fetchAudioBuffer(e.src)
            .then(function() {
              var n;
              return (
                (n = t.context.createBufferSource()),
                (n.buffer = i[e.src]),
        ...
        getMediaSource: (function() {
          ...
          return function() {
            ...
            var n = this.context.createMediaElementSource(this.audio);
            return (t[e] = n), n;
          };
        })()
      });
