  ...
  /******/ [
    ...
    /***/ function(module, exports) {
      !(function(t) {
        function e(i) {
          ...
          var d = (a[i] = { exports: {}, id: i, loaded: !1 });
          return (
            t[i].call(d.exports, d, d.exports, e), (d.loaded = !0), d.exports
          );
        }
        var a = {};
            ...
            draw: function() {
              function t(t, e, a, i, d, o, u, r, s) {
                o || (o = 1e-5),
                  ...
                  t.moveTo(e, a + o),
                  t.lineTo(e, a + d - o),
                  t.quadraticCurveTo(e, a + d, e + o, a + d),
                  t.lineTo(e + i - u, a + d),
                  t.quadraticCurveTo(e + i, a + d, e + i, a + d - u),
                  t.lineTo(e + i, a + s),
                  t.quadraticCurveTo(e + i, a, e + i - s, a),
                  t.lineTo(e + r, a),
                  t.quadraticCurveTo(e, a, e, a + r);
              }
              ...
              return (
                this.data.topLeftRadius != -1 &&
                  (a[0] = this.data.topLeftRadius),
                this.data.topRightRadius != -1 &&
                  (a[1] = this.data.topRightRadius),
                this.data.bottomLeftRadius != -1 &&
                  (a[2] = this.data.bottomLeftRadius),
                this.data.bottomRightRadius != -1 &&
                  (a[3] = this.data.bottomRightRadius),
                t(
                  e,
                  0,
                  0,
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var opacityUpdate = function opacityUpdate(opacity) {
        ...
        try {
          for (
            var _iterator = this.textEntities[Symbol.iterator](), _step;
	...
	*/
      Utils.preloadAssets = function(assets_arr) {
        ...
        try {
          for (
            var _iterator = assets_arr[Symbol.iterator](), _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
            ...
            try {
              for (
                var _iterator2 = assets.children[Symbol.iterator](), _step2;
	...
	*/
      ...
      Utils.updateOpacity = function(el, opacity) {
        ...
        try {
          for (
            var _iterator3 = el.querySelectorAll("a-text")[Symbol.iterator](),
              _step3;
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      Draw.key = function(id, type, value) {
        ...
        el.shadow_el.setAttribute(
          "position",
          Config.KEY_WIDTH / 2 + " " + Config.KEY_WIDTH / 2 + " -0.002"
        );
        ...
        if (type === "text" || type === "spacebar" || type === "symbol") {
          ...
          letter_el.setAttribute(
            "position",
            Config.KEY_WIDTH / 2 + " " + Config.KEY_WIDTH / 2 + " 0.01"
          );
        ...
        if (type === "spacebar") {
          ...
          el.shadow_el.setAttribute(
            "position",
            Config.SPACE_KEY_WIDTH / 2 +
              " " +
              Config.SPACE_KEY_HEIGHT / 2 +
              " -0.02"
          );
        ...
        if (type === "backspace" || type === "enter" || type === "dismiss") {
          ...
          el.shadow_el.setAttribute(
            "position",
            Config.ACTION_WIDTH / 2 + " " + Config.KEY_WIDTH / 2 + " -0.02"
          );
        }
        ...
        // ENTER
          ...
          el.shadow_el.setAttribute(
            "position",
            Config.ACTION_WIDTH / 2 + " " + Config.ACTION_WIDTH / 2 + " -0.02"
          );
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      Behaviors.showKeyboard = function(el) {
        ...
        try {
          for (
            var _iterator = el.querySelectorAll("[data-ui]")[Symbol.iterator](),
              _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
            ...
            try {
              for (
                var _iterator2 = item.children[Symbol.iterator](), _step2;
                !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next())
                  .done);
                _iteratorNormalCompletion2 = true
              ) {
      ...
      Behaviors.openKeyboard = function(el) {
        ...
        try {
          var _loop = function _loop() {
            ...
            try {
              for (
                var _iterator4 = item.children[Symbol.iterator](), _step4;
            ...
            function animationend() {
              item.children[0].removeEventListener(
                "animationend",
                animationend
              );
              setTimeout(function() {
      ...
      Behaviors.dismissKeyboard = function(el) {
        ...
        try {
          var _loop2 = function _loop2() {
            ...
            try {
              for (
                var _iterator6 = item.children[Symbol.iterator](), _step6;
      ...
      Behaviors.shiftToggle = function() {
        ...
        try {
          for (
            var _iterator7 = document
                .querySelectorAll("[key-id]")
                [Symbol.iterator](),
              _step7;
      ...
      AFRAME.registerComponent("input", {
        ...
        blink: function blink() {
          ...
          this.cursorInterval = setInterval(function() {
            that.cursor.setAttribute(
              "visible",
              !that.cursor.getAttribute("visible")
            );
          }, 500);
        },
        isFocused: false,
        ...
        updateText: function updateText() {
          ...
          function getTextWidth(el, data, trimFirst, _widthFactor) {
            ...
            if (v.line) {
              ...
              v =
                (v.position[0] + v.data.width) /
                (_widthFactor / that.data.width);
              var textRatio =
                (v + padding.left + padding.right) / that.data.width;
          ...
          setTimeout(function() {
            if (that.text.object3D) {
              ...
              if (
                children[0] &&
                children[0].geometry &&
                children[0].geometry.visibleGlyphs
              ) {
                var v = 0;
          ...
          this.text.setAttribute(
            "position",
            padding.left - 0.001 + this.data.width / 2 + " 0 0.002"
          );
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      AFRAME.registerComponent("checkbox", {
        ...
        init: function init() {
          ...
          this.inside.setAttribute(
            "position",
            0.156 / 8 + " -" + 0.156 / 2 + " 0.02"
          );
      ...
      AFRAME.registerComponent("toast", {
        ...
        show: function show() {
          ...
          setTimeout(function() {
            ...
            setTimeout(function() {
              Utils.updateOpacity(that.label, 1);
              that.action.components.button.shadow.setAttribute(
                "visible",
                false
              );
            }, 10);
