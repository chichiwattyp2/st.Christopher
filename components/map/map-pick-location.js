...
const openStreetMaps_attribution =
...
class MapPickLocation extends HTMLElement {
  ...
  connectedCallback() {
    ...
    let setLocationButton = this.shadowRoot.querySelector(
      ".set-location-button"
    );
  ...
  createMap() {
    map = L.map(this.mapRoot).setView(
      this.mapConfig.center,
      this.mapConfig.onLoad_zoom
    );
    ...
    let leafletControlAttribution = shadow.querySelector(
